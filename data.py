...
order_form_data = [
    ['Кристина', 'Панченко', 1, 'Домодедово', '79152223344', datetime.datetime.now().strftime("%d.%m.%Y"), 1, 'black', 'Комментарий'],
    ['Иван', 'Иванов', 2, 'Новосибирск', '89261112233', (datetime.datetime.now()+datetime.timedelta(days=7)).strftime("%d.%m.%Y"), 2, 'grey', 'Длинный такой комментарий для курьера, чтобы устал читатать его пока везет заказ']
]
